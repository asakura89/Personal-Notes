...
GetExceptionMessage : The term 'GetExceptionMessage' is not recognized as the name of a cmdlet, function, script file, or 
operable program. Check the spelling of the name, or if a path was included, verify that the path is correct and try again.
At line:68 char:24
+                 Log "$(GetExceptionMessage $_.Exception)"
+                        ~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : ObjectNotFound: (GetExceptionMessage:String) [], CommandNotFoundException
